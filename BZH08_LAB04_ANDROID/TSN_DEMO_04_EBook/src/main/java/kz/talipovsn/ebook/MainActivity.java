...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.WhatIsComputer);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.WhatIsComputer);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.WhatIsComputer) {
            webView.loadUrl(resourceDir + "PAGE01/WhatIsComputer.htm");
        } else if (id == R.id.HistoryOfComputer) {
            webView.loadUrl(resourceDir + "PAGE02/HistoryOfComputer.htm");
        } else if (id == R.id.manuf) {
            webView.loadUrl(resourceDir + "PAGE03/manuf.htm");
        } else if (id == R.id.devices) {
            webView.loadUrl(resourceDir + "Full/Insides/insides.htm");
        } else if (id == R.id.insides) {
            webView.loadUrl(resourceDir + "Full/Devices/devices.htm");
